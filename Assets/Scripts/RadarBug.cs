...
public class RadarBug : MonoBehaviour
{
    ...
    private IEnumerator RadarBugSequence()
    {
        ...
        // ── Phase 2: interaction logic goes here ───────────────────────────────
        // Add radar bug specific behaviour here
        // Get rid of wait for 1 seconds behaviour and replace with finger uncurling interaction
